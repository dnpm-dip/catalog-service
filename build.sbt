...
lazy val dependencies =
  new {
    ...
    val atc_package  = "de.dnpm.dip"   %% "atc-catalogs-packaged" % "1.1.1" % Test
    val icd10gm_impl = "de.dnpm.dip"   %% "icd10gm-impl"          % "1.1.3" % Test
    val icdo3_impl   = "de.dnpm.dip"   %% "icdo3-impl"            % "1.1.3" % Test
    val icd_package  = "de.dnpm.dip"   %% "icd-claml-packaged"    % "1.1.3" % Test
    val hgnc_impl    = "de.dnpm.dip"   %% "hgnc-gene-set-impl"    % "1.1.2" % Test
    val rd_model     = "de.dnpm.dip"   %% "rd-dto-model"          % "1.2.0" % Test
    val ordo         = "de.dnpm.dip"   %% "orphanet-ordo"         % "1.2.0" % Test
